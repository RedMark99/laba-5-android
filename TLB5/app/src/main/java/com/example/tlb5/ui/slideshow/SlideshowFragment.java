...
public class SlideshowFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new Hotel(R.drawable.mus1, Util.museum_title1, Util.museum_street1, Util.museum_reit1, Util.museum_time1));
        list.add(new Hotel(R.drawable.mus2, Util.museum_title2, Util.museum_street2, Util.museum_reit2, Util.museum_time2));
        list.add(new Hotel(R.drawable.mus3, Util.museum_title3, Util.museum_street3, Util.museum_reit3, Util.museum_time3));
